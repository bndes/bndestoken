import { Component, EventEmitter, HostListener, Inject, Injectable, Input, NgModule, Output, ViewChild, ViewEncapsulation } from '@angular/core';
...
var ServiceDefault = (function () {
    ...
    ServiceDefault.prototype.headers = function (parametros) {
        ...
        var opcoes = new RequestOptions({ headers: headers });
        return opcoes;
    };
...
ServiceDefault.ctorParameters = function () { return [
    { type: undefined, decorators: [{ type: Inject, args: ['bndesUxConfig',] },] },
    { type: Http, },
    { type: Router, },
    { type: BnAlertsService, },
]; };
...
var BnLoginService = (function (_super) {
    ...
    function BnLoginService() {
        ...
        _this.novoLoginUsuario = new Subject$1();
...
BnCabecalhoComponent.propDecorators = {
    'nomeSistema': [{ type: Input },],
    'options': [{ type: Input },],
    'notificacoesErrosAssincronos': [{ type: ViewChild, args: ['logErrosAssincronos',] },],
};
...
export { BndesUx4, BnAlertsService, BnAlertsComponent, BnBoxUsuarioTopoComponent, BnCabecalhoComponent, BnContextMenuComponent, BnLoadingComponent, BnMenuPrincipalModule, BnNotificacoesComponent, BnBuscaBoxSuperiorComponent, AuthenticationGuard, BnAuthenticationService, ServiceDefault, BnLoginService, BnTelaLogin, BnTelaLoginComponent };
